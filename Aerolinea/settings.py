...
SECRET_KEY = 'django-insecure-zves096#n(!i&x^7^^r&04tfwz&_=-%08@77@d4a9*j1-6!sr*'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'templates'],  # Asegúrate de que el directorio 'templates' esté correctamente configurado
